#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""整理 均衡信念（Faiths of Balance）内容到已有分类目录。

源目录：pf_data/phase1/pf_rules_md/未整理/均衡信念FoB
...
SRC_DIR = BASE / "pf_rules_md/未整理/均衡信念FoB"
ORG_DIR = BASE / "pf_rules_md_organized"
REPORT_PATH = BASE / "FaithsOfBalance_reorganization_report.md"

SOURCE_BOOK = "均衡信念（Faiths of Balance）"
SOURCE_BOOK_SHORT = "均衡信念FoB"
...
def main() -> None:
    ...
    process_aggregate(
        ...
        "装备",
        "__aggregate__",
        ORG_DIR / "装备_魔法物品" / "魔法物品" / "奇物" / "无位置" / "均衡信念FoB_物品.md",
        "均衡信念FoB 物品",
        "## 均衡信念FoB 物品",
    )
