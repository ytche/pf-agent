#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""整理 异能国度（Occult Realms）内容到已有分类目录。

源目录：pf_data/phase1/pf_rules_md/未整理/异能国度OR
...
SRC_DIR = BASE / "pf_rules_md/未整理/异能国度OR"
ORG_DIR = BASE / "pf_rules_md_organized"
REPORT_PATH = BASE / "OccultRealms_reorganization_report.md"

SOURCE_BOOK = "异能国度（Occult Realms）"
SOURCE_BOOK_SHORT = "异能国度OR"
...
def main() -> None:
    ...
    mappings = [
        (
            ...
            "职业选项 → 催眠师",
            "umbral_mesmerist",
            ORG_DIR / "职业" / "异能冒险（Occult Adventures）" / "催眠师" / "异能国度OR_催眠师变体.md",
            "异能国度OR 操影师变体",
            "## 异能国度OR 操影师变体",
        ),
        (
            ...
            "职业选项 → 操念使",
            "kineticist_talents",
            ORG_DIR / "职业" / "异能冒险（Occult Adventures）" / "操念使" / "异能国度OR_操念使原力.md",
            "异能国度OR 操念使原力",
            "## 异能国度OR 操念使原力",
        ),
        (
            ...
            "职业选项 → 唤魂师",
            "emotional_focuses",
            ORG_DIR / "职业" / "异能冒险（Occult Adventures）" / "唤魂师" / "异能国度OR_魅影情感羁绊.md",
            "异能国度OR 魅影情感羁绊",
            "## 异能国度OR 魅影情感羁绊",
        ),
        (
