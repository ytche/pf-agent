#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""整理 内海舰船（Ships of the Inner Sea）内容到已有分类目录。

源目录：pf_data/phase1/pf_rules_md/未整理/内海舰船
...
SRC_DIR = BASE / "pf_rules_md/未整理/内海舰船"
ORG_DIR = BASE / "pf_rules_md_organized"
REPORT_PATH = BASE / "InnerSeaShips_reorganization_report.md"

SOURCE_BOOK = "内海舰船（Ships of the Inner Sea）"
SOURCE_BOOK_SHORT = "内海舰船"
