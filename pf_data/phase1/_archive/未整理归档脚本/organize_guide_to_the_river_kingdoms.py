#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""整理 河域诸国指南（Guide to the River Kingdoms）内容到已有分类目录。

源目录：pf_data/phase1/pf_rules_md/未整理/河域诸国指南GttRK
...
SRC_DIR = BASE / "pf_rules_md/未整理/河域诸国指南GttRK"
ORG_DIR = BASE / "pf_rules_md_organized"
REPORT_PATH = BASE / "GuideToTheRiverKingdoms_reorganization_report.md"

SOURCE_BOOK = "河域诸国指南（Guide to the River Kingdoms）"
SOURCE_BOOK_SHORT = "河域诸国指南GttRK"
...
def main() -> None:
    ...
    item_block = clean_aggregate((SRC_DIR / "物品26.md").read_text(encoding="utf-8"))
    ...
    if item_block:
        process_aggregate(
            ...
            "物品26.md",
            "装备/物品 → 奇物",
            "salve_of_the_second_chance",
            ORG_DIR / "装备_魔法物品" / "魔法物品" / "奇物" / "河域诸国指南GttRK_奇物.md",
            "河域诸国指南GttRK 奇物",
            "## 河域诸国指南GttRK 奇物",
            block=item_block,
        )
