#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""整理 切利亚斯，魔鬼帝国（Cheliax, Empire of Devils）内容到已有分类目录。

源目录：pf_data/phase1/pf_rules_md/未整理/切利亚斯，魔鬼帝国
...
SRC_DIR = BASE / "pf_rules_md/未整理/切利亚斯，魔鬼帝国"
ORG_DIR = BASE / "pf_rules_md_organized"
REPORT_PATH = BASE / "CheliaxEmpireOfDevils_reorganization_report.md"

SOURCE_BOOK = "切利亚斯，魔鬼帝国（Cheliax, Empire of Devils）"
SOURCE_BOOK_SHORT = "切利亚斯EOD"
...
def main() -> None:
    ...
    text = clean_aggregate((SRC_DIR / "page_1584.md").read_text(encoding="utf-8"))
