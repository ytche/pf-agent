#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""整理 经典恐怖再临（Classic Horrors Revisited）内容到已有分类目录。"""
...
SRC_DIR = BASE / "pf_rules_md/未整理/经典恐怖再临Classic Horrors Revisited"
ORG_DIR = BASE / "pf_rules_md_organized"
REPORT_PATH = BASE / "ClassicHorrorsRevisited_reorganization_report.md"

SOURCE_BOOK = "经典恐怖再临（Classic Horrors Revisited）"
SOURCE_BOOK_SHORT = "经典恐怖再临CHR"
...
def main() -> None:
    ...
    block = clean_aggregate((SRC_DIR / "新武器3.md").read_text(encoding="utf-8"))
