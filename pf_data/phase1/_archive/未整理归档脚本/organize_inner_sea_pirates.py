#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""整理 内海海盗（Pirates of the Inner Sea）PIS 内容到已有分类目录。

源目录：pf_data/phase1/pf_rules_md/未整理/内海海盗
...
SRC_DIR = BASE / "pf_rules_md/未整理/内海海盗"
ORG_DIR = BASE / "pf_rules_md_organized"
REPORT_PATH = BASE / "InnerSeaPirates_reorganization_report.md"

SOURCE_BOOK = "内海海盗（Pirates of the Inner Sea）PIS"
SOURCE_BOOK_SHORT = "PIS"
...
def main() -> None:
    ...
    process_aggregate(
        ...
        "装备",
        "__aggregate__",
        ORG_DIR / "装备_魔法物品" / "武器" / "内海海盗PIS_武器.md",
        "内海海盗 PIS 武器",
        "## 内海海盗 PIS 武器",
    )
    ...
    process_aggregate(
        ...
        "装备",
        "__aggregate__",
        ORG_DIR / "装备_魔法物品" / "内海海盗PIS_炼金物品.md",
        "内海海盗 PIS 炼金物品",
        "## 内海海盗 PIS 炼金物品",
    )
    ...
    process_aggregate(
        ...
        "进阶职业",
        "__aggregate__",
        ORG_DIR / "职业" / "进阶职业" / "内海海盗PIS_内海海盗.md",
        "内海海盗 PIS 内海海盗",
        "## 内海海盗 PIS 内海海盗",
    )
    ...
    process_aggregate(
        ...
        "装备",
        "__aggregate__",
        ORG_DIR / "装备_魔法物品" / "货品服务" / "内海海盗PIS_装备.md",
        "内海海盗 PIS 装备",
        "## 内海海盗 PIS 装备",
    )

    report["skipped"].append("装备：炼金物品1.md 焦油炸弹（Tar Bomb）与 装备4.md 中焦油炸弹条目重复，已分别聚合；无需额外处理")
