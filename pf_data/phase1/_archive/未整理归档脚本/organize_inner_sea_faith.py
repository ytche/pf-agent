#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""整理 内海信仰（Inner Sea Faiths）ISF 内容到已有分类目录。

源目录：pf_data/phase1/pf_rules_md/未整理/内海信仰ISF
...
SRC_DIR = BASE / "pf_rules_md/未整理/内海信仰ISF"
ORG_DIR = BASE / "pf_rules_md_organized"
REPORT_PATH = BASE / "InnerSeaFaith_reorganization_report.md"

SOURCE_BOOK = "内海信仰（Inner Sea Faiths）ISF"
SOURCE_BOOK_SHORT = "ISF"
...
def main() -> None:
    ...
    target_path = ORG_DIR / "信仰" / "内海信仰ISF_服从仪典与神恩.md"
    target_title = "内海信仰 ISF 服从仪典与神恩"
    heading = "## 内海信仰 ISF 服从仪典与神恩"

    src_files = sorted(p.name for p in SRC_DIR.iterdir() if p.is_file() and p.suffix == ".md")
