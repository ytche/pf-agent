#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""整理 Pathfinder Campaign Setting 内容到已有分类目录。"""
...
SRC_DIR = BASE / "pf_rules_md/未整理/Pathfinder Campaign Setting"
ORG_DIR = BASE / "pf_rules_md_organized"
REPORT_PATH = BASE / "PathfinderCampaignSetting_reorganization_report.md"

SOURCE_BOOK = "Pathfinder Campaign Setting"
SOURCE_BOOK_SHORT = "PFCS"
...
def main() -> None:
    ...
    block = clean_aggregate((SRC_DIR / "专长40.md").read_text(encoding="utf-8"))
