#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""整理 格拉里昂的兽人（Orcs of Golarion）内容到已有分类目录。

源目录：pf_data/phase1/pf_rules_md/未整理/格拉里昂的兽人
...
SRC_DIR = BASE / "pf_rules_md/未整理/格拉里昂的兽人"
ORG_DIR = BASE / "pf_rules_md_organized"
REPORT_PATH = BASE / "OrcsOfGolarion_reorganization_report.md"

SOURCE_BOOK = "格拉里昂的兽人（Orcs of Golarion）"
SOURCE_BOOK_SHORT = "格拉里昂的兽人"
...
def main() -> None:
    ...
    process_aggregate(
        ...
        "背景特性",
        "__aggregate__",
        ORG_DIR / "背景特性" / "格拉里昂的兽人_种族背景特性.md",
        "格拉里昂的兽人 种族背景特性",
        "## 格拉里昂的兽人 种族背景特性",
    )
