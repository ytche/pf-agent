#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""整理 格拉里昂的侏儒（Gnomes of Golarion）内容到已有分类目录。

源目录：pf_data/phase1/pf_rules_md/未整理/格拉里昂的侏儒
...
SRC_DIR = BASE / "pf_rules_md/未整理/格拉里昂的侏儒"
ORG_DIR = BASE / "pf_rules_md_organized"
REPORT_PATH = BASE / "GnomesOfGolarion_reorganization_report.md"

SOURCE_BOOK = "格拉里昂的侏儒（Gnomes of Golarion）"
SOURCE_BOOK_SHORT = "格拉里昂的侏儒"
...
def main() -> None:
    ...
    process_aggregate(
        ...
        "背景特性",
        "__aggregate__",
        ORG_DIR / "背景特性" / "格拉里昂的侏儒_种族背景特性.md",
        "格拉里昂的侏儒 种族背景特性",
        "## 格拉里昂的侏儒 种族背景特性",
    )
    ...
    process_aggregate(
        ...
        "种族特性",
        "__aggregate__",
        ORG_DIR / "种族" / "核心种族" / "侏儒" / "格拉里昂的侏儒_脱色症.md",
        "格拉里昂的侏儒 脱色症",
