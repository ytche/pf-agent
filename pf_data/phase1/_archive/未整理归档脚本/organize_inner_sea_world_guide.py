#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""整理 内海世界指南（Inner Sea World Guide）ISWG 内容到已有分类目录。

源目录：pf_data/phase1/pf_rules_md/未整理/内海世界指南ISWG
...
SRC_DIR = BASE / "pf_rules_md/未整理/内海世界指南ISWG"
ORG_DIR = BASE / "pf_rules_md_organized"
REPORT_PATH = BASE / "InnerSeaWorldGuide_reorganization_report.md"

SOURCE_BOOK = "内海世界指南（Inner Sea World Guide）ISWG"
SOURCE_BOOK_SHORT = "ISWG"
...
def make_source_annotation(source_file: str, l3: str = "") -> str:
    ...
    return f"> 来源：{SOURCE_BOOK}，页码见原书，未整理 → 内海世界指南ISWG{l3_part}"
...
def main() -> None:
    ...
    process_aggregate(
        ...
        "装备",
        "__aggregate__",
        ORG_DIR / "装备_魔法物品" / "内海世界指南ISWG_武器.md",
        "内海世界指南 ISWG 新武器",
        "## 内海世界指南 ISWG 新武器",
    )
    ...
    process_aggregate(
        ...
        "魔法物品",
        "__aggregate__",
        ORG_DIR / "装备_魔法物品" / "内海世界指南ISWG_魔法物品.md",
        "内海世界指南 ISWG 魔法物品",
        "## 内海世界指南 ISWG 魔法物品",
    )
