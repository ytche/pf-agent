#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""整理 格拉里昂的狗头人（Kobolds of Golarion）内容到已有分类目录。

源目录：pf_data/phase1/pf_rules_md/未整理/格拉里昂的狗头人
...
SRC_DIR = BASE / "pf_rules_md/未整理/格拉里昂的狗头人"
ORG_DIR = BASE / "pf_rules_md_organized"
REPORT_PATH = BASE / "KoboldsOfGolarion_reorganization_report.md"

SOURCE_BOOK = "格拉里昂的狗头人（Kobolds of Golarion）"
SOURCE_BOOK_SHORT = "格拉里昂的狗头人"
...
def main() -> None:
    ...
    process_aggregate(
        ...
        "背景特性",
        "__aggregate__",
        ORG_DIR / "背景特性" / "格拉里昂的狗头人_种族背景特性.md",
        "格拉里昂的狗头人 种族背景特性",
        "## 格拉里昂的狗头人 种族背景特性",
    )
    ...
    process_aggregate(
        ...
        "种族特性",
        "__aggregate__",
        ORG_DIR / "种族" / "其他种族" / "狗头人" / "格拉里昂的狗头人_可选天赋职业奖励.md",
        "格拉里昂的狗头人 可选天赋职业奖励",
        "## 格拉里昂的狗头人 可选天赋职业奖励",
    )
    ...
    process_aggregate(
        ...
        "职业选项",
        "__aggregate__",
        ORG_DIR / "职业" / "核心职业" / "牧师" / "格拉里昂的狗头人_牧师子域.md",
        "格拉里昂的狗头人 牧师子域",
        "## 格拉里昂的狗头人 牧师子域",
    )
    ...
    process_aggregate(
        ...
        "装备",
        "__aggregate__",
        ORG_DIR / "装备_魔法物品" / "货品服务" / "格拉里昂的狗头人_炼金物品.md",
        "格拉里昂的狗头人 炼金物品",
        "## 格拉里昂的狗头人 炼金物品",
    )
    ...
    process_aggregate(
        ...
        "种族特性",
        "__aggregate__",
        ORG_DIR / "种族" / "其他种族" / "狗头人" / "格拉里昂的狗头人_种族替换特性.md",
        "格拉里昂的狗头人 种族替换特性",
        "## 格拉里昂的狗头人 种族替换特性",
    )
