#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""整理 异能奥秘（Occult Mysteries）内容到已有分类目录。"""
...
SRC_DIR = BASE / "pf_rules_md/未整理/异能奥秘OM"
ORG_DIR = BASE / "pf_rules_md_organized"
REPORT_PATH = BASE / "OccultMysteries_reorganization_report.md"

SOURCE_BOOK = "异能奥秘（Occult Mysteries）"
SOURCE_BOOK_SHORT = "异能奥秘OM"
...
def main() -> None:
    ...
    entries = [
        (
            ...
            "职业选项 → 先知",
            "oracle_mystery",
            ORG_DIR / "职业" / "基础职业" / "先知" / "异能奥秘OM_先知秘示域.md",
            "异能奥秘OM 通灵秘示域",
            "## 异能奥秘OM 通灵秘示域",
        ),
        (
            ...
            "规则 → 占星事件",
            "astrological_events",
            ORG_DIR / "规则" / "异能奥秘OM_占星事件.md",
            "异能奥秘OM 占星事件",
            "## 异能奥秘OM 占星事件",
        ),
    ]

    for src_name, l3, entry_name, target, title, heading in entries:
        block = clean_aggregate((SRC_DIR / src_name).read_text(encoding="utf-8"))
