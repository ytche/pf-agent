#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""整理 格拉里昂的矮人（Dwarves of Golarion）内容到已有分类目录。

源目录：pf_data/phase1/pf_rules_md/未整理/格拉里昂的矮人
...
SRC_DIR = BASE / "pf_rules_md/未整理/格拉里昂的矮人"
ORG_DIR = BASE / "pf_rules_md_organized"
REPORT_PATH = BASE / "DwarvesOfGolarion_reorganization_report.md"

SOURCE_BOOK = "格拉里昂的矮人（Dwarves of Golarion）"
SOURCE_BOOK_SHORT = "格拉里昂的矮人"
...
def main() -> None:
    ...
    process_aggregate(
        ...
        "背景特性",
        "__aggregate__",
        ORG_DIR / "背景特性" / "格拉里昂的矮人_种族背景特性.md",
        "格拉里昂的矮人 种族背景特性",
        "## 格拉里昂的矮人 种族背景特性",
    )
    ...
    process_aggregate(
        ...
        "装备",
        "__aggregate__",
        ORG_DIR / "装备_魔法物品" / "货品服务" / "格拉里昂的矮人_矮人酒品.md",
        "格拉里昂的矮人 矮人酒品",
        "## 格拉里昂的矮人 矮人酒品",
    )
