#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""整理 贝尔克泽恩，兽人部落之地（Belkzen, Hold of Orc Hordes）内容到已有分类目录。

源目录：pf_data/phase1/pf_rules_md/未整理/贝尔克泽恩，兽人部落之地BHotOH
...
SRC_DIR = BASE / "pf_rules_md/未整理/贝尔克泽恩，兽人部落之地BHotOH"
ORG_DIR = BASE / "pf_rules_md_organized"
REPORT_PATH = BASE / "BelkzenHoldOfOrcHordes_reorganization_report.md"

SOURCE_BOOK = "贝尔克泽恩，兽人部落之地（Belkzen, Hold of Orc Hordes）"
SOURCE_BOOK_SHORT = "贝尔克泽恩BHotOH"
...
def main() -> None:
    ...
    companion_block = clean_aggregate((SRC_DIR / "新伙伴.md").read_text(encoding="utf-8"))
