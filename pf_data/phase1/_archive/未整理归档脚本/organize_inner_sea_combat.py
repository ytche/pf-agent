#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""整理 内海战斗（Inner Sea Combat）ISC 内容到已有分类目录。

源目录：pf_data/phase1/pf_rules_md/未整理/内海战斗
...
SRC_DIR = BASE / "pf_rules_md/未整理/内海战斗"
ORG_DIR = BASE / "pf_rules_md_organized"
REPORT_PATH = BASE / "InnerSeaCombat_reorganization_report.md"

SOURCE_BOOK = "内海战斗（Inner Sea Combat）ISC"
SOURCE_BOOK_SHORT = "ISC"
...
def make_source_annotation(source_file: str, l3: str = "") -> str:
    ...
    return f"> 来源：{SOURCE_BOOK}，页码见原书，未整理 → 内海战斗ISC{l3_part}"
...
def main() -> None:
    ...
    process_aggregate(
        ...
        "魔法物品",
        "__aggregate__",
        ORG_DIR / "装备_魔法物品" / "内海战斗ISC_魔法护甲和盾牌.md",
        "内海战斗 ISC 魔法护甲和盾牌",
        "## 内海战斗 ISC 魔法护甲和盾牌",
    )
    ...
    process_aggregate(
        ...
        "魔法物品",
        "__aggregate__",
        ORG_DIR / "装备_魔法物品" / "内海战斗ISC_魔法武器.md",
        "内海战斗 ISC 魔法武器",
        "## 内海战斗 ISC 魔法武器",
    )
    ...
    process_aggregate(
        ...
        "魔法物品",
        "__aggregate__",
        ORG_DIR / "装备_魔法物品" / "内海战斗ISC_戒指权杖奇物.md",
        "内海战斗 ISC 戒指、权杖与奇物",
        "## 内海战斗 ISC 戒指、权杖与奇物",
    )
