#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""整理 内海种族（Inner Sea Races）ISR 内容到已有分类目录。

源目录：pf_data/phase1/pf_rules_md/未整理/内海种族
...
SRC_DIR = BASE / "pf_rules_md/未整理/内海种族"
ORG_DIR = BASE / "pf_rules_md_organized"
REPORT_PATH = BASE / "InnerSeaRaces_reorganization_report.md"

SOURCE_BOOK = "内海种族（Inner Sea Races）ISR"
SOURCE_BOOK_SHORT = "ISR"
...
def main() -> None:
    ...
    process_aggregate(
        ...
        "种族",
        "核心种族替换特性",
        ORG_DIR / "种族" / "内海种族ISR_核心种族替换特性.md",
        "内海种族 ISR 核心种族替换特性",
        "## 内海种族 ISR 核心种族替换特性",
    )
    ...
    process_aggregate(
        ...
        "种族",
        "其他种族替换特性",
        ORG_DIR / "种族" / "内海种族ISR_其他种族替换特性.md",
        "内海种族 ISR 其他种族替换特性",
        "## 内海种族 ISR 其他种族替换特性",
    )

    new_races_target = ORG_DIR / "种族" / "内海种族ISR_新种族.md"
    process_aggregate(
        report,
        "新种族/page_1598.md",
        "种族",
    ...
    process_aggregate(
        ...
        "装备",
        "魔法护甲和武器",
        ORG_DIR / "装备_魔法物品" / "内海种族ISR_魔法护甲和武器.md",
        "内海种族 ISR 魔法护甲和武器",
        "## 内海种族 ISR 魔法护甲和武器",
    )
