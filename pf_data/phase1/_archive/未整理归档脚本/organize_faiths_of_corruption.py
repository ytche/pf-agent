#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""整理 堕落信念（Faiths of Corruption）内容到已有分类目录。

源目录：pf_data/phase1/pf_rules_md/未整理/堕落信念FoC
...
SRC_DIR = BASE / "pf_rules_md/未整理/堕落信念FoC"
ORG_DIR = BASE / "pf_rules_md_organized"
REPORT_PATH = BASE / "FaithsOfCorruption_reorganization_report.md"

SOURCE_BOOK = "堕落信念（Faiths of Corruption）"
SOURCE_BOOK_SHORT = "堕落信念FoC"
