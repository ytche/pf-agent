#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""整理 神话源始（Mythic Origins）内容到已有分类目录。"""
...
SRC_DIR = BASE / "pf_rules_md/未整理/神话源始MO"
ORG_DIR = BASE / "pf_rules_md_organized"
REPORT_PATH = BASE / "MythicOrigins_reorganization_report.md"

SOURCE_BOOK = "神话源始（Mythic Origins）"
SOURCE_BOOK_SHORT = "神话源始MO"
...
def main() -> None:
    ...
    block = clean_aggregate((SRC_DIR / "神话魔法物品.md").read_text(encoding="utf-8"))
    ...
    if block:
        process_aggregate(
            ...
            "装备/魔法物品",
            "mythic_magic_items",
            ORG_DIR / "装备_魔法物品" / "神话源始MO_神话魔法物品.md",
            "神话源始MO 神话魔法物品",
            "## 神话源始MO 神话魔法物品",
            block=block,
        )
