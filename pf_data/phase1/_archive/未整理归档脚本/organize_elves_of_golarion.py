#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""整理 格拉里昂的精灵（Elves of Golarion）内容到已有分类目录。

源目录：pf_data/phase1/pf_rules_md/未整理/格拉里昂的精灵
...
SRC_DIR = BASE / "pf_rules_md/未整理/格拉里昂的精灵"
ORG_DIR = BASE / "pf_rules_md_organized"
REPORT_PATH = BASE / "ElvesOfGolarion_reorganization_report.md"

SOURCE_BOOK = "格拉里昂的精灵（Elves of Golarion）"
SOURCE_BOOK_SHORT = "格拉里昂的精灵"
...
def main() -> None:
    ...
    process_aggregate(
        ...
        "背景特性",
        "__aggregate__",
        ORG_DIR / "背景特性" / "格拉里昂的精灵_种族背景特性.md",
        "格拉里昂的精灵 种族背景特性",
        "## 格拉里昂的精灵 种族背景特性",
    )
    ...
    process_aggregate(
        ...
        "装备",
        "__aggregate__",
        ORG_DIR / "装备_魔法物品" / "格拉里昂的精灵_附魔箭矢.md",
        "格拉里昂的精灵 附魔箭矢",
        "## 格拉里昂的精灵 附魔箭矢",
    )
    ...
    process_aggregate(
        ...
        "装备",
        "__aggregate__",
        ORG_DIR / "装备_魔法物品" / "格拉里昂的精灵_魔法食物.md",
        "格拉里昂的精灵 魔法食物",
        "## 格拉里昂的精灵 魔法食物",
    )
    ...
    process_aggregate(
        ...
        "进阶职业",
        "__aggregate__",
        ORG_DIR / "职业" / "进阶职业" / "格拉里昂的精灵_寻光者.md",
        "格拉里昂的精灵 寻光者",
