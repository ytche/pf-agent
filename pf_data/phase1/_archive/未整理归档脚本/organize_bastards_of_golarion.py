#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""整理 格拉里昂的混种（Bastards of Golarion）内容到已有分类目录。

源目录：pf_data/phase1/pf_rules_md/未整理/格拉里昂的混种
...
SRC_DIR = BASE / "pf_rules_md/未整理/格拉里昂的混种"
ORG_DIR = BASE / "pf_rules_md_organized"
REPORT_PATH = BASE / "BastardsOfGolarion_reorganization_report.md"

SOURCE_BOOK = "格拉里昂的混种（Bastards of Golarion）"
SOURCE_BOOK_SHORT = "格拉里昂的混种"
...
def main() -> None:
    ...
    process_aggregate(
        ...
        "背景特性",
        "__aggregate__",
        ORG_DIR / "背景特性" / "格拉里昂的混种_种族背景特性.md",
        "格拉里昂的混种 种族背景特性",
        "## 格拉里昂的混种 种族背景特性",
    )
    ...
    process_aggregate(
        ...
        "装备",
        "__aggregate__",
        ORG_DIR / "装备_魔法物品" / "格拉里昂的混种_魔法物品.md",
        "格拉里昂的混种 魔法物品",
        "## 格拉里昂的混种 魔法物品",
    )
