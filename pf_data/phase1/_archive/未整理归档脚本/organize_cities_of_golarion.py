#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""整理 格拉里昂的城市（Cities of Golarion）内容到已有分类目录。

源目录：pf_data/phase1/pf_rules_md/未整理/格拉里昂的城市CoG
...
SRC_DIR = BASE / "pf_rules_md/未整理/格拉里昂的城市CoG"
ORG_DIR = BASE / "pf_rules_md_organized"
REPORT_PATH = BASE / "CitiesOfGolarion_reorganization_report.md"

SOURCE_BOOK = "格拉里昂的城市（Cities of Golarion）"
SOURCE_BOOK_SHORT = "格拉里昂的城市CoG"
