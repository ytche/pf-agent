...
SRC_DIR = BASE / "pf_rules_md/未整理/灵异未解之谜"
ORG_DIR = BASE / "pf_rules_md_organized"
REPORT_PATH = BASE / "MysteriesUnexplained_reorganization_report.md"

SOURCE_BOOK = "灵异未解之谜"
SOURCE_BOOK_SHORT = "灵异未解之谜MU"
...
def main() -> None:
    ...
    block = clean_aggregate((SRC_DIR / "page_534.md").read_text(encoding="utf-8"))
    ...
    if block:
        process_aggregate(
            ...
            "职业选项 → 先知秘示域",
            "occult_mystery",
            ORG_DIR / "职业" / "基础职业" / "先知" / f"{SOURCE_BOOK_SHORT}_先知秘示域.md",
            f"{SOURCE_BOOK_SHORT} 先知秘示域",
            f"## {SOURCE_BOOK_SHORT} 通灵秘示域",
            block=block,
        )
