#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""整理 巨龙再临（Dragons Revisited）内容到已有分类目录。"""
...
SRC_DIR = BASE / "pf_rules_md/未整理/巨龙再临DR"
ORG_DIR = BASE / "pf_rules_md_organized"
REPORT_PATH = BASE / "DragonsRevisited_reorganization_report.md"

SOURCE_BOOK = "巨龙再临（Dragons Revisited）"
SOURCE_BOOK_SHORT = "巨龙再临DR"
...
def main() -> None:
    ...
    block = clean_aggregate((SRC_DIR / "专长34.md").read_text(encoding="utf-8"))
