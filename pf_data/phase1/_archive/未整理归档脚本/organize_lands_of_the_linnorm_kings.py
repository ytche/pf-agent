#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""整理 林诺姆诸王之国（Lands of the Linnorm Kings）内容到已有分类目录。

源目录：pf_data/phase1/pf_rules_md/未整理/林诺姆诸王之国
...
SRC_DIR = BASE / "pf_rules_md/未整理/林诺姆诸王之国"
ORG_DIR = BASE / "pf_rules_md_organized"
REPORT_PATH = BASE / "LandsOfTheLinnormKings_reorganization_report.md"

SOURCE_BOOK = "林诺姆诸王之国（Lands of the Linnorm Kings）"
SOURCE_BOOK_SHORT = "林诺姆诸王之国LotLK"
...
def main() -> None:
    ...
    item_block = clean_aggregate((SRC_DIR / "page_1592.md").read_text(encoding="utf-8"))
    ...
    if item_block:
        process_aggregate(
            ...
            ORG_DIR / "装备_魔法物品" / "魔法物品" / "奇物" / "林诺姆诸王之国LotLK_奇物.md",
            "林诺姆诸王之国LotLK 奇物",
            "## 林诺姆诸王之国LotLK 奇物",
            block=item_block,
        )
