#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""整理 奈多，阴影之地（Nidal, Land of Shadows）内容到已有分类目录。

源目录：pf_data/phase1/pf_rules_md/未整理/奈多，阴影之地
...
SRC_DIR = BASE / "pf_rules_md/未整理/奈多，阴影之地"
ORG_DIR = BASE / "pf_rules_md_organized"
REPORT_PATH = BASE / "NidalLandOfShadows_reorganization_report.md"

SOURCE_BOOK = "奈多，阴影之地（Nidal, Land of Shadows）"
SOURCE_BOOK_SHORT = "奈多"
...
def main() -> None:
    ...
    # 1. 神器
    artifact_block = clean_aggregate((SRC_DIR / "神器.md").read_text(encoding="utf-8"))
    artifact_block = _normalize_stars(artifact_block)
    artifact_block = _collapse_blank_lines(artifact_block.strip())
    if artifact_block:
        process_aggregate(
            report,
            "神器.md",
    ...
    # 2. 神秘仪式
    ritual_block = clean_aggregate((SRC_DIR / "仪式1.md").read_text(encoding="utf-8"))
