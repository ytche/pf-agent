#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""整理 纽梅利亚，星落之地（Numeria, Land of Fallen Stars）内容到已有分类目录。

源目录：pf_data/phase1/pf_rules_md/未整理/纽梅利亚，星落之地NLoFS
...
SRC_DIR = BASE / "pf_rules_md/未整理/纽梅利亚，星落之地NLoFS"
ORG_DIR = BASE / "pf_rules_md_organized"
REPORT_PATH = BASE / "NumeriaLandOfFallenStars_reorganization_report.md"

SOURCE_BOOK = "纽梅利亚，星落之地（Numeria, Land of Fallen Stars）"
SOURCE_BOOK_SHORT = "纽梅利亚NLoFS"
...
def main() -> None:
    ...
    fluid_block = clean_aggregate((SRC_DIR / "纽梅利亚液体.md").read_text(encoding="utf-8"))
    fluid_block = _collapse_blank_lines(fluid_block.strip())
    if fluid_block:
        process_aggregate(
            report,
            "纽梅利亚液体.md",
            "装备/物品 → 炼金物品",
            "numerian_fluids",
            ORG_DIR / "装备_魔法物品" / "炼金物品" / "纽梅利亚NLoFS_纽梅利亚液体.md",
            "纽梅利亚NLoFS 纽梅利亚液体",
            "## 纽梅利亚NLoFS 纽梅利亚液体",
            block=fluid_block,
        )
