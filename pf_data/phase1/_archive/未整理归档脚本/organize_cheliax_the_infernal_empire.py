#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""整理 切利亚斯，炼狱帝国（Cheliax, The Infernal Empire）内容到已有分类目录。

源文件：pf_data/phase1/pf_rules_md/未整理/切利亚斯，炼狱帝国CtIE.md
...
SRC_FILE = BASE / "pf_rules_md/未整理/切利亚斯，炼狱帝国CtIE.md"
ORG_DIR = BASE / "pf_rules_md_organized"
REPORT_PATH = BASE / "CheliaxTheInfernalEmpire_reorganization_report.md"

SOURCE_BOOK = "切利亚斯，炼狱帝国（Cheliax, The Infernal Empire）"
SOURCE_BOOK_SHORT = "切利亚斯CtIE"
...
def process_aggregate(
    ...
    if block is None:
        block = clean_aggregate(SRC_FILE.read_text(encoding="utf-8"))
...
def main() -> None:
    ...
    text = clean_aggregate(SRC_FILE.read_text(encoding="utf-8"))
    ...
    process_aggregate(
        ...
        "种族替换特性 → 替换儿",
        "pyrophile",
        ORG_DIR / "种族" / "切利亚斯CtIE_替换儿种族选项.md",
        "切利亚斯CtIE 替换儿种族选项",
        "## 切利亚斯CtIE 替换儿种族选项",
        block=text,
    )
